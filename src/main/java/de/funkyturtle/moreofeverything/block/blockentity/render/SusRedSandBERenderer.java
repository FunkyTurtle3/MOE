package de.funkyturtle.moreofeverything.block.blockentity.render;
            ...
            if (i > 0) {
                ...
                if (direction != null) {
                    ...
                    if (!itemstack.isEmpty()) {
                        ...
                        this.itemRenderer
                                .renderStatic(itemstack, ItemDisplayContext.FIXED, j, OverlayTexture.NO_OVERLAY, pPoseStack, pBufferSource, pBlockEntity.getLevel(), 0);
                        pPoseStack.popPose();
                    }
                }
            }
