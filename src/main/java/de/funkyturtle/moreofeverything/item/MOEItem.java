...
public class MOEItem {
    ...
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_4 = ITEMS.register("mysterious_material_4", () -> new MysteriousMaterial(new Item.Properties(), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material_4"));
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_5 = ITEMS.register("mysterious_material_5", () -> new MysteriousMaterial(new Item.Properties(), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material_5"));
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_6 = ITEMS.register("mysterious_material_6", () -> new MysteriousMaterial(new Item.Properties(), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material_6"));
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_7 = ITEMS.register("mysterious_material_7", () -> new MysteriousMaterial(new Item.Properties(), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material_7"));
