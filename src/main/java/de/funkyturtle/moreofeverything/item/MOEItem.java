...
public class MOEItem {
    ...
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_1 = ITEMS.register("mysterious_material_1", () -> new MysteriousMaterial(new Item.Properties().rarity(Rarity.RARE).stacksTo(1).component(MOEDataComponentTypes.LOCKED.get(), Boolean.FALSE).durability(16), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material"));
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_2 = ITEMS.register("mysterious_material_2", () -> new MysteriousMaterial(new Item.Properties().rarity(Rarity.RARE).stacksTo(1).component(MOEDataComponentTypes.LOCKED.get(), Boolean.FALSE).durability(16), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material"));
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_3 = ITEMS.register("mysterious_material_3", () -> new MysteriousMaterial(new Item.Properties().rarity(Rarity.RARE).stacksTo(1).component(MOEDataComponentTypes.LOCKED.get(), Boolean.FALSE).durability(16), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material"));
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_4 = ITEMS.register("mysterious_material_4", () -> new MysteriousMaterial(new Item.Properties().rarity(Rarity.RARE).stacksTo(1).component(MOEDataComponentTypes.LOCKED.get(), Boolean.FALSE).durability(16), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material"));
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_5 = ITEMS.register("mysterious_material_5", () -> new MysteriousMaterial(new Item.Properties().rarity(Rarity.RARE).stacksTo(1).component(MOEDataComponentTypes.LOCKED.get(), Boolean.FALSE).durability(16), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material"));
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_6 = ITEMS.register("mysterious_material_6", () -> new MysteriousMaterial(new Item.Properties().rarity(Rarity.RARE).stacksTo(1).component(MOEDataComponentTypes.LOCKED.get(), Boolean.FALSE).durability(16), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material"));
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_7 = ITEMS.register("mysterious_material_7", () -> new MysteriousMaterial(new Item.Properties().rarity(Rarity.RARE).stacksTo(1).component(MOEDataComponentTypes.LOCKED.get(), Boolean.FALSE).durability(16), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material"));
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_8 = ITEMS.register("mysterious_material_8", () -> new MysteriousMaterial(new Item.Properties().rarity(Rarity.RARE).stacksTo(1).component(MOEDataComponentTypes.LOCKED.get(), Boolean.FALSE).durability(16), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material"));
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_9 = ITEMS.register("mysterious_material_9", () -> new MysteriousMaterial(new Item.Properties().rarity(Rarity.RARE).stacksTo(1).component(MOEDataComponentTypes.LOCKED.get(), Boolean.FALSE).durability(16), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material"));
    public static final RegistryObject<MysteriousMaterial> MYSTERIOUS_MATERIAL_10 = ITEMS.register("mysterious_material_10", () -> new MysteriousMaterial(new Item.Properties().rarity(Rarity.RARE).stacksTo(1).component(MOEDataComponentTypes.LOCKED.get(), Boolean.FALSE).durability(16), new ItemStack(Items.DIAMOND), "tooltip.moreofeverything.mysterious_material"));
